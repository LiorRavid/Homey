...
export function PopDestination({ onSearch }) {
    ...
    return (
        <main className="top-cities-gallery">
            ...
            <Link to="/explore" onClick={() => { onSelectTopCity('New York') }} className="top-cities-card clean-link">
            ...
            <Link to="/explore" onClick={() => { onSelectTopCity('Sydney') }} className="top-cities-card clean-link">
            ...
            <Link to="/explore" onClick={() => { onSelectTopCity('London') }} className="top-cities-card clean-link">
            ...
            <Link to="/explore" onClick={() => { onSelectTopCity('Paris') }} className="top-cities-card clean-link">
