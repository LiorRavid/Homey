    ...
    return (
        <main className="top-cities-gallery">
           ...
           <section className='top-cities'>
            ...
            <Link to="/explore" onClick={() => { onSelectTopCity('Bangkok') }} className="top-cities-card clean-link">
            ...
            <Link to="/explore" onClick={() => { onSelectTopCity('Madrid') }} className="top-cities-card clean-link">
